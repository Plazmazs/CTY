...
while dead=='no':
    ...
    pause()
    print('it deals 15 damage at base level and gives you a SuperPoint')
    pause()
    ...
    pause()
    bigbird=character('bigbird',60,15,15,10,60,0,0,0,0)
    ...
    Drake=character('Drake',200,20,7,2,200,0,0,0,50)
