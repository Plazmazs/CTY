            ...
            if choice=='health' or choice=='damage'or choice=='dodging'or choice=='applepie'  or choice=='apple pie' or choice=='astrothunder'or choice=='sicko mode' or choice=='sickomode' or choice=='critical' :
                if choice == 'health':
                    ...
                    if self.dodging<10:
                        ...
                        print('cannot upgrade dodging, maxed.')
                        Travis.Upgrade('')
                elif choice == 'critical':
                    if self.critical<10:
                        self.critical+=random.randint(0,2)
                        print(f'Crit skill is now {self.critical}')
                    else:
                        print('cannot upgrade critical, maxed.')
                elif choice == 'applepie' or choice=='apple pie':
                    self.applepie+=random.randint(4,12)
                    ...
                    self.sickomode+=random.randint(15,40)
...
def Combat(Travishp,Travisdmg,Travisdodging,Traviscrit,Travispriority,Travismaxhealth,Travisapplepie,Travisastrothunder,Travissickomode,Enemyname,Enemyhp,Enemydmg,Enemydodging,Enemycritical,Enemypriority,Enemymaxhealth,Enemyapplepie,Enemyastrothunder,Enemysickomode,SuperPoints):
    ...
    if Travishp>0:
        pause()
        print(' ')
        print(f'you healed for {int((Travismaxhealth-Travishp)/3)} health')
        pause()
...
while dead=='no':
    ...
    skeletons=character('skeletons',random.randint(200,450),random.randint(14,25),random.randint(1,3),1,0,400,0,0,0)
    ...
    Drake=character('Drake',200,random.randint(16,30),random.randint(3,7),random.randint(2,6),random.randint(-1,3),200,0,0,random.randint(35,60))
    ...
    sickomode='unlocked'
    pause()
    print('base sicko mode deals 50 damage and heals for 50 health')
    pause()
    print('you will go to utopia')
    pause()
...
░░███  ░░███  ░░███                        ░░░                                
 ...
 ░░████████    ░░█████ ░░██████  ░███████  █████░░████████                    
  ░░░░░░░░      ░░░░░   ░░░░░░   ░███░░░  ░░░░░  ░░░░░░░░                     
    ...
    pause()
    TopiaTwins=character('TopiaTwins',random.randint(150,300),random.randint(15,35),random.randint(2,8),random.randint(2,8),random.randint(0,3),300,0,0,0)
    ...
    Travis.hp,SuperPoints=Combat(Travis.hp,Travis.dmg,Travis.dodging,Travis.critical,Travis.priority,Travis.maxhealth,Travis.applepie,Travis.astrothunder,Travis.sickomode,Kanye.name,Kanye.hp,Kanye.dmg,Kanye.dodging,Kanye.critical,Kanye.priority,Kanye.maxhealth,Kanye.applepie,Kanye.astrothunder,Kanye.sickomode,SuperPoints)
